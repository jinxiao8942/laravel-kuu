...
class AddAutoCheckFormLaravelValidator extends AbstractLaravelValidator {
	...
	protected $messages = array(
        ...
        'dns.ip_exists'=>'Resolved IP is not responding.',
        ...
        'http.http_exists' =>'This HTTP address does not exist.',
		'https.https_exists' => 'This HTTPS address does not exist.',
		);
	...
	public function registerCustomValidators()
	{
		...
		$this->validator->extend('ip_exists',function($attribute,$value,$parameters){
			return $this->sendEchoRequest($value);
		});
    ...
    protected function sendEchoRequest($host , $timeout = 1){
