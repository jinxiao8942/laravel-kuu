...
class UserController extends BaseController {
	...
	public function store()
	{
        ...
        if( $result['success'] )
        {
            ...
            return Redirect::action('UserController@create', array('lang' =>App::getLocale()))
                ->withInput()
	...
	public function destroy($id)
	{
		...
		{
			Session::flash('success', trans('kuu-validation.user_deleted'));
            return Redirect::to('/users');
        }
        else 
        {
        	Session::flash('error', trans('kuu-validation.unable_to_delete_user'));
            return Redirect::to('/users');
        }
	}
	...
	public function resend()
	{
        ...
        {
            Session::flash('error', $result['message']);
            return Redirect::route('profile', array('lang' =>App::getLocale()))
                ->withInput()
	...
	public function forgot()
	{
        ...
        {
            Session::flash('error', $result['message']);
            return Redirect::route('forgotPasswordForm', array('lang' =>App::getLocale()))
                ->withInput()
	...
	public function accountpage(){
		...
		$data_model = array(
			...
			'isEmfUser'			=> Sentry::getUser()->hasAnyAccess(['emf.login'])
		);
	...
	public function accountpageupdate_personal(){
		...
		try{
			...
			if ( $user->save() ){
				Session::flash('success', trans('kuu-validation.successfully_updated'));
			} else {
				Session::flash('error', trans('kuu-validation.error_happened'));
			}
		} catch (Cartalyst\Sentry\Users\UserExistsException $e) {
			Session::flash('duplicateemail', Input::get( 'email' ) . trans('kuu-validation.already_exists'));
		} catch (Cartalyst\Sentry\Users\UserNotFoundException $e) {
			echo trans('kuu-validation.user_was_not_found');
		}
		
		return Redirect::route('account', array('lang' =>App::getLocale()));
	}
	...
	public function accountpageupdate_password(){
		...
		try{			
			...
			try{
				...
				Session::flash('error', trans('kuu-validation.current_password_does_not_match'));
	...
	public function addAccountAlertEmail(){
		...
		$subject = trans('kuu-validation.confirm_your_alert_email');
