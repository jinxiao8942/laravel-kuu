...
jQuery(document).ready(function(){
	...
	jQuery("#manual_http_add_alert_email").click(function(){
		...
		if( pattern.test( alert_email ) ) {
			jQuery("#manual_http_alert_list").append('<li><span class="pull-left">' + alert_email + '</span><a class="remove_check_alert_email pull-right" href="#"><span class="small-close"></span></a><input type="hidden" name="check_alert_email[]" value="' + alert_email + '"></li>');
	...
	jQuery("#manual_https_add_alert_email").click(function(){
		...
		if( pattern.test( alert_email ) ) {
			jQuery("#manual_https_alert_list").append('<li><span class="pull-left">' + alert_email + '</span><a class="remove_check_alert_email pull-right" href="#"><span class="small-close"></span></a><input type="hidden" name="check_alert_email[]" value="' + alert_email + '"></li>');
	...
	jQuery("#manual_dns_add_alert_email").click(function(){
		...
		if( pattern.test( alert_email ) ) {
			jQuery("#manual_dns_alert_list").append('<li><span class="pull-left">' + alert_email + '</span><a class="remove_check_alert_email pull-right" href="#"><span class="small-close"></span></a><input type="hidden" name="check_alert_email[]" value="' + alert_email + '"></li>');
	...
	jQuery("#auto_add_alert_email").click(function(){
		...
		if( pattern.test( alert_email ) ) {
			jQuery("#auto_alert_list").append('<li><span class="pull-left">' + alert_email + '</span><a class="remove_check_alert_email pull-right" href="#"><span class="small-close"></span></a><input type="hidden" name="check_alert_email[]" value="' + alert_email + '"></li>');
